...
import { MenuUnfoldOutlined, MenuFoldOutlined, UserOutlined, TeamOutlined, DashboardOutlined, CustomerServiceOutlined, MailOutlined } from '@ant-design/icons'
    ...
    return (
      <Sider trigger={null} collapsible collapsed={collapsed} onCollapse={this.toggleCollapsed} theme='light'>
        ...
        >
          ...
          <Menu.Item icon={<MailOutlined />} key='Booking'>
